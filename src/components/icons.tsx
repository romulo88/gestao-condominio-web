...
/** Cadeado - pedido do Romulo: ícone de Mensagem privada no menu (trocado do balãozinho
 * de conversa pra reforçar o "privado"/segredo), mesmo pra morador e funcionário. */
export function IconeMensagemPrivada({ className }: IconeProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
